...
<HTML><HEAD><TITLE>Error Message Hint</TITLE>
...
<TABLE cellSpacing=0 cellPadding=0 width="80%" border=0>
  <TBODY>
  <TR>
    <TD><IMG src="${pageContext.request.contextPath}/404/1.gif" width="17" height="18"></TD>
    <TD width="100%" 
    background="${pageContext.request.contextPath}/404/3.gif"></TD>
    <TD><IMG 
src="${pageContext.request.contextPath}/404/2.gif" width="17" height="18"></TD>
  </TR></TBODY></TABLE>
<TABLE cellSpacing=0 cellPadding=0 width="80%" border=0>
  <TBODY>
  <TR>
    <TD width=7 
background="${pageContext.request.contextPath}/404/left.gif"></TD>
...
//-->
    ...
    <TD width=7 
    background="${pageContext.request.contextPath}/404/right.gif"></TD></TR></TBODY></TABLE>
<TABLE cellSpacing=0 cellPadding=0 width="80%" border=0>
  <TBODY>
  <TR>
    <TD width=7 
        ...
        <TR>
          <TD class=bg_1 align=middle height=300>
            <TABLE cellSpacing=0 cellPadding=0 width=590 border=0>
              ...
              <TR>
                <TD align=right><IMG 
                  src="${pageContext.request.contextPath}/404/center_error.gif" width="450" height="32" 
                  border=0></TD>
              </TR>
              <TR>
                  ...
                  <TABLE cellSpacing=0 cellPadding=0 width=534 border=0>
                    ...
                    <TR>
                      <TD colSpan=3><IMG height=42 
                        src="${pageContext.request.contextPath}/404/error_r1_c1.gif" 
                        width=534 border=0></TD>
                      <TD></TD></TR>
                    <TR>
                      <TD rowSpan=2><IMG height=239 
                        src="${pageContext.request.contextPath}/404/error_r2_c1.gif" 
                      ...
                      <span style="color: red;font-weight: 900;font-size: 40px;">404</span><br><br>
                        <P><FONT 
                        class=red size="5"><b>Page does not exist</b></FONT><BR><BR><font color="blue" size="3">Your IP has been recorded. Please do not make illegal operation!</font><BR><BR>
                        <P style="font-size: 14px">Please contact administrator</P>
                        <p>
                        <a href="javascript:void(0)" onclick="history.go(-1)" style="font-weight: 400;color:seagreen;font-size: 16px;float: right;">--->> Back to page</a>
                        </p>
                        </TD>
                      <TD rowSpan=2><IMG height=239 
                        src="${pageContext.request.contextPath}/404/error_r2_c3.gif" 
                        width=12 border=0></TD>
                      <TD></TD></TR>
                    <TR>
                      <TD><IMG height=11 
                        src="${pageContext.request.contextPath}/404/error_r3_c2.gif" 
  ...
  <TR>
    <TD class=bg align=middle width=*>
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TBODY>
        <TR>
          <TD><IMG src="${pageContext.request.contextPath}/404/4.gif" width="17" height="18"></TD>
          <TD width="100%" 
          background="${pageContext.request.contextPath}/404/6.gif"></TD>
          <TD><IMG 
        src="${pageContext.request.contextPath}/404/5.gif" width="17" height="18"></TD>
        </TR></TBODY></TABLE><BR>
