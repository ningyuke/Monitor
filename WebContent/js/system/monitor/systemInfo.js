$(function() {
	...
	option = {
		legend : {
			data : [ 'JVM RAM usage', 'Physical RAM usage', 'CPU usage' ]
		},
		 tooltip : {
	         enterable:true,
	         trigger: 'axis',
	...
	one_option = {
		    ...
		    series : [
		        {
		            ...
		            type:'gauge',
		            data:[{value: 50, name: 'JVM RAM usage'}]
		        }
		    ]
		};
	 two_option = {
	 ...
	 one_option.series[0].data[0].name ='RAM usage';
	...
	var timeTicket = setInterval(function() {
		...
		$.ajax({
			type : "POST",
			url : rootPath + '/system/monitor/usage.shtml',
			async : false,
			dataType : 'json',
			success : function(json) {
				...
				one_option.series[0].data[0].name ='JVM RAM usage';
