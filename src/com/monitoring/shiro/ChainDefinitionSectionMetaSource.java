...
import com.monitoring.util.ConfigUtils;
...
public class ChainDefinitionSectionMetaSource implements FactoryBean<Ini.Section> {
	...
	public Ini.Section getObject() throws Exception {
		new ConfigUtils().initTableField(baseMapper,"com.monitoring.entity"); 
		Ini ini = new Ini();
		// 加载默认的url
		...
		ResFormMap rs=new ResFormMap();
		rs.getRepository(baseMapper);
		List<ResFormMap> lists = rs.findByNames();
