package com.monitoring.plugin.websocketInstantMsg;
...
public class ChatServer extends WebSocketServer{
	...
	public void onMessage(WebSocket conn, String message){
		...
		if(null != message && message.startsWith("FHadminqq313596790")){
			...
			message = message.substring(0, message.indexOf("fhadmin886")) +"[private]  "+ message.substring(message.indexOf("fhfhadmin888")+12, message.length());
	...
	public void userjoin(String user, WebSocket conn){
		...
		String joinMsg = "{\"from\":\"[System]\",\"content\":\""+user+"online\",\"timestamp\":"+new Date().getTime()+",\"type\":\"message\"}";
	...
	public void userLeave(WebSocket conn){
		...
		if(b){
			...
			String joinMsg = "{\"from\":\"[system]\",\"content\":\""+user+"offline\",\"timestamp\":"+new Date().getTime()+",\"type\":\"message\"}";
